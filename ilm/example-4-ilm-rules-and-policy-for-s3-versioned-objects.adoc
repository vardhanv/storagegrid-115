...
link:how-s3-versioned-objects-are-deleted.html[How S3 versioned objects are deleted]

link:verifying-ilm-policy-with-object-metadata-lookup.html[Verifying an ILM policy with object metadata lookup]
