...
image::../media/autosupport_results_tab.png[AutoSupport results tab]
...
Learn how to configure email server settings in the link:../monitor/index.html[monitor & troubleshoot instructions].
