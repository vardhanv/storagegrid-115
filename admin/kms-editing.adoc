...
* If you plan to update the site selected for a KMS, you must have reviewed the link:kms-considerations-for-changing-for-site.html[considerations for changing the KMS for a site].
