...
. When you are done, return to StorageGRID and link:testing-relying-party-trusts.html[test all relying party trusts] to confirm they are configured correctly.
