...
You can use the Diagnostics page to obtain additional information on the current state of your grid. See link:../monitor/running-diagnostics.html.html[Running diagnostics].
