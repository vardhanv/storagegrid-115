...
You can use the Diagnostics page to obtain additional information on the current state of your grid. See xref:../monitor/running-diagnostics.html.adoc[Running diagnostics].
