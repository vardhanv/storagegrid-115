...
NOTE: If you are unable to log in to the grid node, the system disk might not be intact. Go to the procedure for recovering from system drive failure. xref:recovering-from-system-drive-failure.adoc[Recovering from system drive failure]
[start=3]
...
xref:recovering-from-system-drive-failure.adoc[Recovering from system drive failure]
