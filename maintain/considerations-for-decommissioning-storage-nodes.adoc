...
link:reviewing-ilm-policy-and-storage-configuration.html[Reviewing the ILM policy and storage configuration]

link:decommissioning-disconnected-storage-nodes.html[Decommissioning disconnected Storage Nodes]

link:consolidating-storage-nodes.html[Consolidating Storage Nodes]

link:decommissioning-multiple-storage-nodes.html[Decommissioning multiple Storage Nodes]
