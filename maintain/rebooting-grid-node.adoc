...
* link:rebooting-grid-node-from-grid-manager.html[Rebooting a grid node from the Grid Manager]
* link:rebooting-grid-node-from-command-shell.html[Rebooting a grid node from the command shell]
