...
|link:decommissioning_disconnected_grid_nodes.adoc[Decommissioning disconnected grid nodes]

|Only connected grid nodes
|link:decommissioning_connected_grid_nodes.adoc[Decommissioning connected grid nodes]
|===
