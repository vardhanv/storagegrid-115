...
* link:guidelines-for-adding-object-capacity.html[Guidelines for adding object capacity]
* link:adding-storage-capacity-for-replicated-objects.html[Adding storage capacity for replicated objects]
* link:adding-storage-capacity-for-erasure-coded-objects.html[Adding storage capacity for erasure-coded objects]
