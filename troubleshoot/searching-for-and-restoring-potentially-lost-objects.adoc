...
link:troubleshooting-storagegrid-system.html[Investigating lost objects]

link:troubleshooting-storagegrid-system.html[Confirming object data locations]

link:troubleshooting-storagegrid-system.html[Resetting lost and missing object counts]
