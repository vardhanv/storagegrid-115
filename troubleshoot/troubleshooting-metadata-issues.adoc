...
link:../monitor/monitoring-object-metadata-capacity-for-each-storage-node.html[Monitoring object metadata capacity for each Storage Node]
...
link:../monitor/running-diagnostics.html[Running diagnostics]
