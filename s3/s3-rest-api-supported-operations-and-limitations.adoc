...
* xref:authenticating-requests.adoc[Authenticating requests]
* xref:operations-on-the-service.adoc[Operations on the service]
* xref:operations-on-buckets.adoc[Operations on buckets]
* xref:custom-operations-on-buckets.adoc[Custom operations on buckets]
...
* xref:error-responses.adoc[Error responses]
