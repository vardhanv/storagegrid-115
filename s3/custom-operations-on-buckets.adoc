...
a|
link:storagegrid-s3-rest-api-operations.html[GET Bucket consistency request]
a|
PUT Bucket consistency
a|
Sets the consistency level applied to a particular bucket.
a|
link:storagegrid-s3-rest-api-operations.html[PUT Bucket consistency request]
a|
...
a|
link:storagegrid-s3-rest-api-operations.html[DELETE Bucket metadata notification configuration request]
a|
GET Bucket metadata notification configuration
a|
Returns the metadata notification configuration XML associated with a particular bucket.
a|
link:storagegrid-s3-rest-api-operations.html[GET Bucket metadata notification configuration request]
a|
...
a|
link:storagegrid-s3-rest-api-operations.html[Deprecated: GET Bucket compliance request]
a|
...
a|
link:storagegrid-s3-rest-api-operations.html[Deprecated: PUT Bucket compliance request]
|===
.Related information
