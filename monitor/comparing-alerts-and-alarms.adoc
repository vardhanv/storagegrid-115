...
a|
You can learn about an alarm by clicking the attribute name, or you can search for an alarm code in the StorageGRID documentation.link:alarms-reference.html[Alarms reference (legacy system)]
...
a|
Select *Support* > *Alarms (legacy)* > *Historical Alarms*. link:managing-alarms.html[Reviewing historical alarms and alarm frequency (legacy system)]
